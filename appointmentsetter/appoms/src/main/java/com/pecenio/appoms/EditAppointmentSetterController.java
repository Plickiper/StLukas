...
public class EditAppointmentSetterController extends GenericAppointmentSetterController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			AppointmentSetter appointmentSetter = toObject(true);
			AppointmentSetter newAppointmentSetter = AppointmentSetterService.getService().update(appointmentSetter);
