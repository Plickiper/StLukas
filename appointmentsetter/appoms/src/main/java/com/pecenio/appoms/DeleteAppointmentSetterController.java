...
public class DeleteAppointmentSetterController extends GenericAppointmentSetterController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			...
			AppointmentSetterService.getService().delete(appointmentSetter.getId());
