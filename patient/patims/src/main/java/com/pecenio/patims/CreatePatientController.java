...
public class CreatePatientController extends GenericPatientController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			Patient patient = toObject(false);
			Patient newPatient = PatientService.getService().create(patient);
			managePatientController.refresh();
