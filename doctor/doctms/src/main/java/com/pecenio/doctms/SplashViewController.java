...
public class SplashViewController implements Initializable {
	...
	public void onClicked(ActionEvent actionEvent)  throws IOException {
		...
		window.hide();
		if(manageScene == null){
			FXMLLoader fxmlLoader = new FXMLLoader(ManageDoctorJFXApp.class.getResource("manage-doct-view.fxml"));
			Parent root = (Parent)fxmlLoader.load();
			ManageDoctorController controller = fxmlLoader.getController();
